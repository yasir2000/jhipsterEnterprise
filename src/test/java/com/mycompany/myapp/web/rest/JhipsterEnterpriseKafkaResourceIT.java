...
class JhipsterEnterpriseKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterEnterpriseKafkaResource kafkaResource = new JhipsterEnterpriseKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-enterprise-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-enterprise-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
