...
@RestController
@RequestMapping("/api/jhipster-enterprise-kafka")
public class JhipsterEnterpriseKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterEnterpriseKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterEnterpriseKafkaResource(KafkaProperties kafkaProperties) {
